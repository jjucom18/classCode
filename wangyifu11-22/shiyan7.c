...

{
	...
	for(j=1;j<=10;j++)
      ...
      //初始化顶点信息
		...
		strcpy(G->vexs[1].introduction ,"是九江学院最繁华的门，也是学生出入最多的大门");
        ...
        strcpy(G->vexs[7].introduction ,"三食堂的饭菜便宜，每天很多学生都会在这吃饭，是人流量最多的食堂");
        strcpy(G->vexs[8].name ,"男生15栋");
        strcpy(G->vexs[8].introduction ,"电子学院男生宿舍");
        strcpy(G->vexs[9].name ,"莲池");
        strcpy(G->vexs[9].introduction ,"莲池里面有很多睡莲，那里有很多情侣在散步，是九江学院环境最好的地方");
