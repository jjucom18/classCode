...
G.vex[4].sight="万福超市";
G.vex[4].description="学校最大的超市";
G.vex[5].sight="学生一食堂";
G.vex[5].description="学生用餐的地方";
G.vex[6].sight="女生宿舍";
G.vex[6].description="女生寝室聚集地";
G.vex[7].sight="学生四服楼";
G.vex[7].description="各种商品售卖处及各种快递领取处";
G.vex[8].sight="男生宿舍";
G.vex[8].description="男生宿舍聚集地";
G.vex[9].sight="学生三食堂";
G.vex[9].description="人流量最多的食堂";
G.vex[10].sight="厚德楼";
G.vex[10].description="校领导办公及部分学生上课的地方";
G.vex[11].sight="香远楼";
G.vex[11].description="英语听力训练的地方";
G.vex[12].sight="公共机房";
