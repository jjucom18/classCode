...
void Init_Graph(Graph *G)
{
    ...
    strcpy(G->place[0].intro,"最热闹的一个门\n");
    G->place[1].index=2;
    strcpy(G->place[1].name ,"竞知楼");
    strcpy(G->place[1].intro,"江西最大的教学楼\n");
    G->place[2].index=3;
    strcpy(G->place[2].name,"一食堂");
    strcpy(G->place[2].intro,"贼难吃\n");
    G->place[3].index=4;
    strcpy(G->place[3].name,"三食堂");
    strcpy(G->place[3].intro,"最经济实惠的食堂\n");
    G->place[4].index=5;
    strcpy(G->place[4].name,"文理实验楼");
    strcpy(G->place[4].intro,"做各种实验的地方\n");
    G->place[5].index=6;
    ...
    strcpy(G->place[7].intro,"文传与理学院\n");
    G->place[8].index=9;
    strcpy(G->place[8].name,"实训楼");
    strcpy(G->place[8].intro,"电子实训中心及楼上有机房\n");
    G->place[9].index=10;
    strcpy(G->place[9].name,"立信楼");
    strcpy(G->place[9].intro,"会计学院\n");
    G->place[10].index=11;
    strcpy(G->place[10].name,"逸夫楼");
    strcpy(G->place[10].intro,"主要收藏工科类的图书，有很多自习室等学习氛围好的地方\n");
    G->place[11].index=12;
    strcpy(G->place[11].name,"西门");
    strcpy(G->place[11].intro,"学校升国旗的地方，最大的一个门\n");
    G->place[12].index=13;
    strcpy(G->place[12].name,"北门");
    strcpy(G->place[12].intro,"靠近艺术学院\n");
    /////////////////////////////////////////
    //具体距离
   G->edge[0][1]=260;
   G->edge[1][0]=130;
...
void show_menu(Graph *G)
{
   ...
   // system("cls");
    ...
    printf("                                                               \n");
    printf("    12.西门                                                    \n");
    printf("                                 9.实训楼   6.文理实验楼       \n");
    printf("           10.立信楼   8.文友楼   7.义丰楼  5.香远楼           \n");
    printf("                                                               \n");
    printf("                                                               \n");
    printf("     4.三食堂                                                  \n");
    printf("                                     3.一食堂      \n");
