...
G.vex[0].description="人流量最多的大门。";

G.vex[1].sight="南门大礼堂";

G.vex[1].description="日常庆典活动，社团演出";
...
G.vex[3].description="江西最大教学楼";

G.vex[4].sight="教工宿舍";

G.vex[4].description="教室宿舍";

G.vex[5].sight="14栋学生宿舍";

G.vex[5].description="电子最帅男生居住地";

G.vex[6].sight="11栋女生宿舍";

G.vex[6].description="电子女生寝室聚集地";
...
G.vex[8].description="人流量最多，九院最大的食堂";

G.vex[9].sight="15栋男生宿舍";

G.vex[9].description="电子男生宿舍聚集地";

G.vex[10].sight="厚德楼";

G.vex[10].description="校领导办公及部分学生上课的地方";

G.vex[11].sight="香远楼";

G.vex[11].description="外国语教学楼";

G.vex[12].sight="实训楼";

G.vex[12].description="学生上机、实训处";
...
G.vex[14].description="篮球、排球、足球场地";

G.vex[15].sight="九江学院北门";

G.vex[15].description="山上的大门";
