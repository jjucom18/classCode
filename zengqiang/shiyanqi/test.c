...
void Init_Graph(Graph *G)
{
    ...
    strcpy(G->place[2].intro,"饭菜美味，管饱\n");
    G->place[3].index=4;
    strcpy(G->place[3].name,"三食堂");
    strcpy(G->place[3].intro,"价格低廉\n");
    G->place[4].index=5;
    strcpy(G->place[4].name,"厚德楼");
    strcpy(G->place[4].intro,"学生动手实践物理实验的地方\n");
    G->place[5].index=6;
    strcpy(G->place[5].name,"香远楼");
    strcpy(G->place[5].intro,"英语听力,外国语学院\n");
    G->place[6].index=7;
