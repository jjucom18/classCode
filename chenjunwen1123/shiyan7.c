...
G.arcs[10][11].adj=50;     
G.arcs[10][12].adj=50;
G.arcs[10][14].adj=500;
G.arcs[11][12].adj=100; 
G.arcs[12][13].adj=1000;    
G.arcs[15][16].adj=600;  
G.arcs[15][17].adj=700; 
G.arcs[16][19].adj=100;      
G.arcs[16][18].adj=100;     
G.arcs[18][20].adj=100;      
G.arcs[19][21].adj=20; 
G.arcs[20][22].adj=800;     
G.arcs[22][23].adj=400;  
G.arcs[19][20].adj=20;    
G.arcs[21][20].adj=10; 
G.arcs[22][20].adj=800;            
