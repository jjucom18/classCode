...
G.vex[0].description="最繁华的大门。";

G.vex[1].sight="南门大礼堂";

G.vex[1].description="讲座、演出晚会等地方";
...
G.vex[4].description="中通快递在旁边";

G.vex[5].sight="女生宿舍";

G.vex[5].description="1至6栋";

G.vex[6].sight="男生宿舍";

G.vex[6].description="9至15栋";

G.vex[7].sight="学生四服楼";

G.vex[7].description="许多快递，打印，超市，杂货";
...
G.vex[10].description="英语、马克思学院";

G.vex[11].sight="文友楼";

G.vex[11].description="会计学院";
